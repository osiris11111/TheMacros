        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center flex flex-col items-center mt-12 md:mt-16 mb-16">
          ...
          <div className="flex flex-col gap-4 w-full max-w-sm md:max-w-none md:w-fit">
            <div className="flex flex-col md:flex-row gap-4 w-full justify-center">
              <button onClick={() => {}} className="bg-primary text-on-primary px-10 py-4 rounded-lg font-['Arial'] font-bold uppercase tracking-widest text-sm hover:bg-primary-container transition-colors w-full">Order Here</button>
            ...
            <button onClick={() => {}} className="bg-primary text-on-primary px-6 py-4 rounded-lg font-['Arial'] font-bold uppercase tracking-widest text-sm hover:bg-primary-container transition-colors w-full flex items-center justify-center gap-2">
              Save Up to 30%
